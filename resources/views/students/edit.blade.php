                        ...
                        <form class="row g-3" action="{{route('school.student.update')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputIdCardNumber" name="id_card_number" placeholder="e.g. 2022-03-01 (Year Class Roll)" required value="{{$promotion_info->id_card_number}}">
                                </div>
                            </div>
